...
int main (int argc, char **argv) {
  ...
  parsleyPtr compiled = parsley_compile(arguments.parselet, incl->buf);
  ...
  parsedParsleyPtr ptr = parsley_parse_html_string_simple(compiled, arguments.html, arguments.flags);
